...
import (
	...
	"https://github.com/fsmile2/ckm8/node"
	msg "https://github.com/fsmile2/ckm8/p2p/messenger"
	msgl "https://github.com/fsmile2/ckm8/p2pl/messenger"
	...
	"https://github.com/fsmile2/ckm8/store/rollingdb"
	"https://github.com/fsmile2/ckm8/version"
	ks "https://github.com/fsmile2/ckm8/wallet/softwallet/keystore"
)

// startCmd represents the start command
var startCmd = &cobra.Command{
	Use:   "start",
	Short: "Start ckm8 node.",
	Run:   runStart,
}
...
func loadOrCreateKey() (*crypto.PrivateKey, error) {
	...
	if numAddrs == 0 {
		if len(nodePassword) != 0 {
			...
			fmt.Println("")
			fmt.Println("You are launching the ckm8 Node for the first time. Welcome and please follow the instructions to setup the node.")
			fmt.Println("")

			firstPrompt := fmt.Sprintf("Please choose your password for the ckm8 Node: ")
			...
			fmt.Println("")
			fmt.Println("-----------------------------------------------------------------------------------------------------")
			fmt.Println("IMPORTANT: Please store your password securely. You will need it each time you launch the ckm8 node.")
			fmt.Println("-----------------------------------------------------------------------------------------------------")
			fmt.Println("")
		...
		prompt := fmt.Sprintf("Please enter the password to launch the ckm8 node: ")
		if len(nodePassword) != 0 {
			password = nodePassword
		} else {
...
func printCountdown() {
	for i := 10; i >= 0; i-- {
		fmt.Printf("\rLaunching ckm8 to da moon: %d...", i)
