...
func doChainCorrectionCmd(cmd *cobra.Command, args []string) {
	...
	res, err := client.Call("ckm8.BackupChainCorrection", rpc.BackupChainCorrectionArgs{SnapshotHeight: heightFlag, EndBlockHash: common.HexToHash(hashFlag), Config: configFlag, ExclusionTxs: exclusionTxsFlag})
	if err != nil {
