...
// Example:
//		ckm8cli backup snapshot
var snapshotCmd = &cobra.Command{
	Use:     "snapshot",
	Short:   "backup snapshot",
	Long:    `Backup snapshot.`,
	Example: `ckm8cli backup snapshot`,
	Run:     doSnapshotCmd,
}
...
func doSnapshotCmd(cmd *cobra.Command, args []string) {
	...
	res, err := client.Call("ckm8.BackupSnapshot", rpc.BackupSnapshotArgs{Config: configFlag, Height: heightFlag, Version: versionFlag})
	if err != nil {
