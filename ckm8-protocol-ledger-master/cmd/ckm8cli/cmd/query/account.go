...
// Example:
//		ckm8cli query account --address=0x2E833968E5bB786Ae419c4d13189fB081Cc43bab
var accountCmd = &cobra.Command{
	Use:     "account",
	Short:   "Get account status",
	Long:    `Get account status.`,
	Example: `ckm8cli query account --address=0x2E833968E5bB786Ae419c4d13189fB081Cc43bab`,
	Run:     doAccountCmd,
}
...
func doAccountCmd(cmd *cobra.Command, args []string) {
	...
	res, err := client.Call("ckm8.GetAccount", rpc.GetAccountArgs{
		Address: addressFlag,
