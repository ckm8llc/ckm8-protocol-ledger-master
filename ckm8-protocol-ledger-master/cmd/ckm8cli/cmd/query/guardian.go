...
// guardianCmd retreves guardian related information from ckm8 server.
// Example:
//		ckm8cli query guardian
var guardianCmd = &cobra.Command{
	Use:     "guardian",
	Short:   "Get guardian info",
	Long:    `Get guardian status.`,
	Example: `ckm8cli query guardian`,
	Run:     doGuardianCmd,
}
...
func doGuardianCmd(cmd *cobra.Command, args []string) {
	...
	res, err := client.Call("ckm8.GetGuardianInfo", rpc.GetGuardianInfoArgs{})
	if err != nil {
