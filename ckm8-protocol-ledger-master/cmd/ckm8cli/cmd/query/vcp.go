...
// Example:
//		ckm8cli query vcp --height=10
var vcpCmd = &cobra.Command{
	Use:     "vcp",
	Short:   "Get validator candidate pool",
	Example: `ckm8cli query vcp --height=10`,
	Run:     doVcpCmd,
}
...
func doVcpCmd(cmd *cobra.Command, args []string) {
	...
	height := heightFlag
	res, err := client.Call("ckm8.GetVcpByHeight", rpc.GetVcpByHeightArgs{Height: common.JSONUint64(height)})
	if err != nil {
