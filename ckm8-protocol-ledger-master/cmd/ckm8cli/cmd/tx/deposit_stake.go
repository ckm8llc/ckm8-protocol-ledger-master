...
import (
	...
	"https://github.com/fsmile2/ckm8/crypto/bls"
...
// Example:
//		ckm8cli tx deposit --chain="privatenet" --source=2E833968E5bB786Ae419c4d13189fB081Cc43bab --holder=2E833968E5bB786Ae419c4d13189fB081Cc43bab --stake=6000000 --purpose=0 --seq=7
var depositStakeCmd = &cobra.Command{
	Use:     "deposit",
	Short:   "Deposit stake to a validator or guardian",
	Example: `ckm8cli tx deposit --chain="privatenet" --source=2E833968E5bB786Ae419c4d13189fB081Cc43bab --holder=2E833968E5bB786Ae419c4d13189fB081Cc43bab --stake=6000000 --purpose=0 --seq=7`,
...
func doDepositStakeCmd(cmd *cobra.Command, args []string) {
	...
	stake, ok := types.ParseCoinAmount(stakeInckm8Flag)
	if !ok {
	...
	if purposeFlag == core.StakeForValidator || purposeFlag == core.StakeForGuardian {
		...
		ckm8Stake = new(big.Int).SetUint64(0)
		tfuelStake = stake
	}
...
func init() {
	...
	depositStakeCmd.Flags().StringVar(&stakeInckm8Flag, "stake", "5000000", "ckm8 amount to stake")
