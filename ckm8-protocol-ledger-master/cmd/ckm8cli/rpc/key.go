...
func (t *ckm8CliRPCService) UnlockKey(args *UnlockKeyArgs, result *UnlockKeyResult) (err error) {
...
func (t *ckm8CliRPCService) LockKey(args *LockKeyArgs, result *LockKeyResult) (err error) {
	address := common.HexToAddress(args.Address)
...
func (t *ckm8CliRPCService) IsKeyUnlocked(args *IsKeyUnlockedArgs, result *IsKeyUnlockedResult) (err error) {
	address := common.HexToAddress(args.Address)
...
func (t *ckm8CliRPCService) NewKey(args *NewKeyArgs, result *NewKeyResult) (err error) {
	password := args.Password
...
func (t *ckm8CliRPCService) ListKeys(args *ListKeysArgs, result *ListKeysResult) (err error) {
