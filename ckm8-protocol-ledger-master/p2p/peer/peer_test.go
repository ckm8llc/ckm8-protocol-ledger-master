...
import (
	...
	cn "github.com/ckm8token/ckm8/p2p/connection"
...
func TestPeerHandshakeAndCommunication(t *testing.T) {
	...
	messagesAtoB := []string{
		...
		"How's everything?",
		"The ckm8 blockchain is awesome!",
		"The ckm8 blockchain is the only end-to-end infrastructure for decentralized video streaming and delivery that provides both technical and economic solutions...This is one of the most exciting new blockchain ventures I have heard about.",
	}
